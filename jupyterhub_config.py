...
#c.JupyterHub.data_files_path = '/g/data/v45/conda/envs/cosima/share/jupyterhub'
...
#  
#  .. versionadded:: 0.9
# c.JupyterHub.hub_bind_url = 'http://127.0.0.1:57001'
...
c.ConfigurableHTTPProxy.api_url = 'http://127.0.0.1:61314'
...
class MyLocalProcessSpawner(LocalProcessSpawner):
...
c.BatchSpawnerBase.req_prologue = """source /g/data/v45/conda/etc/profile.d/conda.sh
...
c.ProfilesSpawner.profiles = [
   ('Gadi - 4 core, 16 GB, 8 hours', 'cpu4', 'batchspawner.PBSSpawner',
      dict(req_nprocs='1', req_runtime='8:00:00', req_memory='4gb')),
   ('Login server', 'local', MyLocalProcessSpawner, {'ip':'0.0.0.0'} ),
   ('Gadi - 1 core, 4 GB, 8 hours', 'cpu1', 'batchspawner.PBSSpawner',
      dict(req_nprocs='1', req_runtime='8:00:00', req_memory='4gb')),
   ('Gadi - 1 node, 48 cores, 192 GB, 4 hours', 'cpu48', 'batchspawner.PBSSpawner',
      dict(req_nprocs='48', req_runtime='4:00:00', req_memory='192gb')),
   ('Gadi - EXPRESS, 1 node, 48 cores, 192 GB, 1 hours', 'cpu48-express', 'batchspawner.PBSSpawner',
      dict(req_nprocs='48', req_runtime='1:00:00', req_memory='192gb', req_queue='express')),
      ]
